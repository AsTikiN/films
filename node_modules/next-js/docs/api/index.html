...
<html>
<head>
  <title><strong>Next JS</strong> API Documentation</title>
...
<body id="ext-body">
  ...
  <div id="header-content"><strong>Next JS</strong> API Documentation</div>
...
<h3>クラスシステム</h3>
<div class='links'>
<a href="#!/api/NX" rel="NX" class="docClass">NX</a>
</div>
</div>
...
<div style='clear:both'></div>
  ...
  <div id='footer-content' style='display: none'>Generated with <a href='https://github.com/senchalabs/jsduck'>JSDuck</a> 3.7.0.</div>
